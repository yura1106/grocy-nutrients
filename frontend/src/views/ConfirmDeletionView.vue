  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <div v-if="!token" class="text-center">
        ...
        <p class="mt-3">
          <router-link to="/profile" class="font-medium text-indigo-600 hover:text-indigo-500">
            Back to profile
          </router-link>
        </p>
      </div>

      <div v-else-if="deleted" class="bg-green-50 border-l-4 border-green-400 p-4">
      ...
      <div v-else class="space-y-6">
        ...
        >
          <span v-if="loading" class="absolute left-0 inset-y-0 flex items-center pl-3">
            <svg class="animate-spin h-5 w-5 text-red-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <p class="text-center">
          <router-link to="/profile" class="text-sm font-medium text-gray-600 hover:text-gray-500">
            Cancel and go back
          </router-link>
        </p>
      </div>
