            ...
            >
              <div class="px-4 py-5 sm:p-6">
                ...
                <div class="mt-4">
                  ...
                  <button
                    @click="clearPreview"
                    class="ml-3 inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
                    Clear
                  </button>
                </div>
