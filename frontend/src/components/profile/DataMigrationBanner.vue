<template>
  ...
  >
    ...
    <div class="flex items-center gap-3">
      ...
      >
        <svg v-if="loading" class="animate-spin -ml-0.5 mr-1.5 h-3 w-3 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    <div v-if="successMessage" class="mt-2 text-xs text-green-600">{{ successMessage }}</div>
  </div>
</template>
